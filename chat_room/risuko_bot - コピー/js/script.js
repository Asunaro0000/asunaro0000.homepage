...
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (modeSelect) {
        const optChat = modeSelect.querySelector('option[value="chat"]');
        const optMaze = modeSelect.querySelector('option[value="maze"]');
        if (optChat) optChat.innerText = (currentLang === 'en') ? "💬 Chat" : "💬 チャット";
        if (optMaze) optMaze.innerText = (currentLang === 'en') ? "🐿️ Risuko's Maze" : "🐿️ リス子の森ナビ";
    }
